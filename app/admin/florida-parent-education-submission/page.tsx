...
import { FLORIDA_PARENT_EDUCATION_SUBMISSION_WORKFLOW } from "@/lib/florida-parent-education-submission"
import { createClient as createSupabaseServerClient } from "@/lib/supabase/server"

export const dynamic = "force-dynamic"

function getStatusClasses(status: "complete" | "submitted" | "monitor") {
  if (status === "complete") {
...
export default async function FloridaParentEducationSubmissionPage() {
  ...
  const workflow = FLORIDA_PARENT_EDUCATION_SUBMISSION_WORKFLOW
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-8">
      ...
      <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        <h2 className="text-xl font-semibold text-slate-900">Parent education workspaces</h2>
