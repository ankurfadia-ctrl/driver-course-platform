...
export default async function SouthDakotaPriceMatchPage() {
  ...
  return (
    <StandardPriceMatchPage
      ...
      title={
        isSpanish
          ? "Envianos un precio público mas bajo de Dakota del Sur para revision"
          : "Send us a lower public South Dakota course price for review"
      }
      description={
        isSpanish
          ? "Si encuentras un precio público mas bajo para un curso en linea comparable de Dakota del Sur, envia los detalles abajo. Revisamos las solicitudes calificadas de forma manual y igualamos el precio verificado o lo mejoramos por $1."
      ...
      requestTitle={
        isSpanish ? "Solicitud de igualación de precio de Dakota del Sur" : "South Dakota price match request"
      }
      emailSubject={
        isSpanish ? "Solicitud de igualación de precio de Dakota del Sur" : "South Dakota price match request"
      }
