...
export default async function MinnesotaPriceMatchPage() {
  ...
  return (
    <StandardPriceMatchPage
      ...
      title={
        isSpanish
          ? "Envianos un precio publico mas bajo de Minnesota para revision"
          : "Send us a lower public Minnesota course price for review"
      }
      description={
        isSpanish
          ? "Si encuentras un precio publico mas bajo para un curso equivalente de educacion para padres de Minnesota en linea, envia los detalles abajo. Revisamos las solicitudes calificadas manualmente y, si se aprueban, igualamos el precio verificado o lo mejoramos por $1."
      ...
      requestTitle={
        isSpanish ? "Solicitud de igualacion de precio de Minnesota" : "Minnesota price match request"
      }
      emailSubject={
        isSpanish ? "Solicitud de igualacion de precio de Minnesota" : "Minnesota price match request"
      }
