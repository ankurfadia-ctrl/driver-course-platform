  ...
  return (
    <div className="mx-auto max-w-5xl space-y-8">
      ...
      <section className="rounded-[2rem] border border-slate-200 bg-slate-50 p-6">
        <h2 className="text-xl font-semibold text-slate-900">Next steps for students</h2>
        <p className="mt-3 max-w-3xl leading-7 text-slate-600">
          Review this information before enrolling. If the course fits your
          situation, you can continue to checkout or return to your student account.
        </p>
        ...
        <p className="mt-4 text-sm text-slate-500">
          Direct page: {getDisclosuresRoute(state)}
        </p>
      </section>
    </div>
  )
