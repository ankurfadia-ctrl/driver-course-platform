...
const footerLinks = {
  ...
  es: [
    ...
    { label: "Educacion para padres de Minnesota", href: "/minnesota-parent-education" },
    { label: "Educacion para padres de Dakota del Sur", href: "/south-dakota-parenting" },
    { label: "Verificacion de certificados", href: "/verify" },
